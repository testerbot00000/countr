...
async function postToAllLists(guildCount, botID, apiKeys) {
    ...
    if (!listData) {
        listData = await bttps.get('https://metalist.xyz/api/lists').catch((e) => console.error(`BLAPI: ${e}`));
        if (!listData) {
            ...
            listData = Object.assign(otherListData, listData);
        }
    }
...
const otherListData = {
    "discordbotlist.xyz": {
        "api_docs": "https://discordbotlist.xyz/api/docs",
        "api_post": "https://discordbotlist.xyz/api/stats/:id",
        "api_field": "count",
        "api_shard_id": null,
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https://discordbotlist.xyz/api/bot/:id"
    }
}
...
const oldListData = {
    ...
    "boatlist.xyz": {
        "api_docs": "https:\/\/boatlist.xyz\/api\/docs\/",
        "api_post": null,
        "api_field": null,
        "api_shard_id": null,
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/boatlist.xyz\/api\/bot\/:id"
    },
    "botlist.space": {
        ...
        "api_shard_count": null,
        "api_shards": "shards",
        "api_get": "https:\/\/botlist.space\/api\/bots\/:id"
    },
    "botsfordiscord.com": {
        ...
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/botsfordiscord.com\/api\/v1\/bots\/:id"
    },
    "bots.ondiscord.xyz": {
    ...
    "discordbots.org": {
        ...
        "api_shards": "shards",
        "api_get": "https:\/\/discordbots.org\/api\/bots\/:id"
    },
    "discordbotlist.com": {
    ...
    "bots.discord.pw": {
        ...
        "api_shard_count": "shard_count",
        "api_shards": null,
        "api_get": "https:\/\/bots.discord.pw\/api\/bots\/:id"
    },
    "discordbotlist.xyz": {
        "api_docs": null,
        "api_post": "https:\/\/discordbotlist.xyz\/api\/stats\/:id",
        ...
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/discordbotlist.xyz\/api\/bot?id=:id"
    },
    "discordbots.group": {
        ...
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/discordbots.group\/api\/bot\/:id"
    },
    "discordbots.co.uk": {
        "api_docs": null,
        "api_post": null,
    ...
    "bots.discordlist.app": {
        "api_docs": "https:\/\/bots.discordlist.app\/api",
        "api_post": "https:\/\/bots.discordlist.app\/api\/bot\/:id\/stats",
        "api_field": "server_count",
        "api_shard_id": null,
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/bots.discordlist.app\/api\/bot\/:id\/stats"
    },
    ...
    "discordsbestbots.xyz": {
        "api_docs": null,
        "api_post": "https:\/\/discordsbestbots.xyz\/api\/bots\/:id",
        "api_field": "guilds",
        "api_shard_id": null,
    ...
    "divinediscordbots.com": {
        ...
        "api_post": "https:\/\/divinediscordbots.com\/bots\/:id\/stats",
        "api_field": "server_count",
        "api_shard_id": null,
        "api_shard_count": "shards",
        "api_shards": null,
        "api_get": "https:\/\/divinediscordbots.com\/bots\/:id\/stats"
    },
    "listcord.com": {
        ...
        "api_shard_count": null,
        "api_shards": null,
        "api_get": "https:\/\/listcord.com\/api\/bot\/:id"
    },
    "ls.terminal.ink": {
        "api_docs": "https:\/\/docs.terminal.ink\/ls\/v1",
        "api_post": null,
        "api_field": null,
        "api_shard_id": null,
        "api_shard_count": null,
